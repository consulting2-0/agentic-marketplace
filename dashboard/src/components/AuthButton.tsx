  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-2.5 px-2.5 py-[6px] rounded-md text-[13px] text-text-secondary hover:text-text-primary hover:bg-surface-2 transition-colors w-full"
      >
        {user.imageUrl ? (
          <img
            src={user.imageUrl}
  ...
  if (!isLoaded) {
    return (
      <div className="flex items-center gap-2.5 px-2.5 py-[6px]">
        <div className="w-6 h-6 rounded-full bg-surface-3 animate-pulse" />
