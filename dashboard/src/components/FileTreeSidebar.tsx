  ...
  return (
    <div>
      <button
        ...
        className="w-full flex items-center gap-1 py-[3px] pr-2 hover:bg-surface-2 transition-colors group/folder"
...
function FileNode({ node, depth }: { node: TreeNode; depth: number }) {
  ...
  return (
    <div
      className="flex items-center gap-1.5 py-[3px] pr-2 hover:bg-surface-2 cursor-default transition-colors"
