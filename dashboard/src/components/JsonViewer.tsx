      ...
      <span className="text-green-400 break-all">
        ...
        {isLong && (
          <button
            ...
            className="ml-1.5 text-[10px] px-1.5 py-0.5 rounded bg-surface-2 hover:bg-surface-3 text-text-tertiary hover:text-text-secondary transition-colors align-middle"
          >
...
function JsonObject({
  ...
  return (
    <div>
      <div
        className="flex items-center gap-1 group/obj cursor-pointer hover:bg-surface-2 rounded py-0.5 transition-colors"
      ...
      >
        ...
        <button
          ...
          className="ml-auto mr-2 opacity-0 group-hover/obj:opacity-100 text-[10px] px-1.5 py-0.5 rounded bg-surface-2 hover:bg-surface-3 text-text-tertiary hover:text-text-secondary transition-all"
...
function JsonArray({
  ...
  return (
    <div>
      <div
        className="flex items-center gap-1 group/arr cursor-pointer hover:bg-surface-2 rounded py-0.5 transition-colors"
        style={{ paddingLeft: `${depth * 1.25 + 0.25}rem` }}
        onClick={() => setOpen(!open)}
      >
        <svg
        ...
        <button
          onClick={(e) => { e.stopPropagation(); handleCopySection(); }}
          className="ml-auto mr-2 opacity-0 group-hover/arr:opacity-100 text-[10px] px-1.5 py-0.5 rounded bg-surface-2 hover:bg-surface-3 text-text-tertiary hover:text-text-secondary transition-all"
          title="Copy this section"
        >
          Copy
        </button>
