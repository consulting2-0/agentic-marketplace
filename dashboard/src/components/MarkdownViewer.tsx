                ...
                {searchResults.map((result, i) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2.5 flex items-start gap-2.5 transition-colors ${
                      i === selectedIdx ? 'bg-surface-3' : 'hover:bg-surface-2'
                    }`}
                  >
                    {result.type === 'heading' ? (
                    ...
                    {i === selectedIdx && (
                      <kbd className="text-[9px] px-1 py-0.5 rounded bg-surface-2 text-text-tertiary font-mono self-center shrink-0">
                        Enter
                      </kbd>
                    )}
                  </button>
